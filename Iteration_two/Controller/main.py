...
from Iteration_two.Model import Course
from NewPreferenceGUI import NewPreferenceGUI
from Iteration_two.Model import SavePreference
from NewPreferenceGUI import NewPreference
...
#def main():
    ...
    #make a course
    system_development = Course("Systemdevelopment","","")
